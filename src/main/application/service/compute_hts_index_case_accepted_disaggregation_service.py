...
class ComputeHtsIndexCaseAcceptedDisaggregationService(ComputeHtsIndexCaseAcceptedDisaggregationUseCase):

    def __init__(self, logger: Logger, index_case_accepted_indicators_metadata_port: IndicatorMetadataPort) -> None:
       self.logger = logger
       self.index_case_accepted_indicators_metadata_port = index_case_accepted_indicators_metadata_port

    def compute(self, index_case_acceptec_patients, end_period):
        indicators = {}

        indicators_metadata = self.index_case_accepted_indicators_metadata_port.find_indicator_metadata()

        for patient in index_case_acceptec_patients:
            ...
            for gender in self.GENDERS:
                ...
                for age_band in self.index_case_accepted_indicators_metadata_port.age_bands():
