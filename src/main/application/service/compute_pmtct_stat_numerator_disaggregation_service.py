...
from src.main.application.income import ComputePmtctStatNumeratorDisaggregationUseCase
from src.main.application.out import IndicatorMetadataPort

class ComputePmtctStatNumeratorDisaggregationService(ComputePmtctStatNumeratorDisaggregationUseCase):

    def __init__(self, logger: Logger, pmtct_stat_numerator_indicator_metadata_port: IndicatorMetadataPort) -> None:
       self.logger = logger
       self.pmtct_stat_numerator_indicator_metadata_port = pmtct_stat_numerator_indicator_metadata_port

    def compute(self, pmtct_stat_patients, end_period):
        
        indicators = {}

        indicators_metadata = self.pmtct_stat_numerator_indicator_metadata_port.find_indicator_metadata()
        ...
        for patient in pmtct_stat_patients:
            ...
            for gender in self.GENDERS:
                ...
                for result in self.RESULTS:
                    ...
                    for age_band in self.pmtct_stat_numerator_indicator_metadata_port.age_bands():
