...
from src.main.application.income import ComputeHtsMalnutritionUseCase


class ComputeHtsMalnutritionService(ComputeHtsMalnutritionUseCase):

    def __init__(self, events_port: EventPort, patient_demographics_port: PatientDemographicsPort) -> None:
    ...
    def compute(self, org_unit, start_period, end_period):
        ...
        for patient_event in patient_events:
            ...
            if patient_event['section'] != 'NUTRICAO':
                continue
