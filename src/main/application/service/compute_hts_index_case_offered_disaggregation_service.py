...
class ComputeHtsIndexCaseOfferedDisaggregationService(ComputeHtsIndexCaseOfferedDisaggregationUseCase):

    def __init__(self, logger:Logger, index_case_offered_indicators_metadata_port: IndicatorMetadataPort) -> None:
      self.logger = logger
      self.index_case_offered_indicators_metadata_port = index_case_offered_indicators_metadata_port

    def compute(self, offered_patients, end_period):
        indicators = {}
        indicators_metadata = self.index_case_offered_indicators_metadata_port.find_indicator_metadata()

        for patient in offered_patients:
            ...
            for gender in self.GENDERS:
                ...
                for age_band in self.index_case_offered_indicators_metadata_port.age_bands():
