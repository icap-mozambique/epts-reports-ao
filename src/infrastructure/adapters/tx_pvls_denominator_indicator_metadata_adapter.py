...
class TxPvlsDenominatorIndicatorMetadataAdapter(IndicatorMetadataPort):

    METADATA_ID = 'zZWXFbrvHUf'
    ...
    def find_indicator_metadata(self):
        ...
        for indicator_metadata in indicators_metadata:
            ...
            name = name.split('TX_PVLS (D, TA, Age/Sex/HIVStatus): Viral Load Documented ')[1]
