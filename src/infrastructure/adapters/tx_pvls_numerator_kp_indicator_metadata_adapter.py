...
class TxPvlsNumeratorKpIndicatorMetadataAdapter(IndicatorMetadataPort):
    
    METADATA_ID = 'rsPZAKIz1OH'
    ...
    def find_indicator_metadata(self):
       ...
       for indicator_metadata in indicators_metadata:
            ...
            name = name.split('TX_PVLS (N, TA, KeyPop/HIVStatus): Viral Load Documented ')[1]
