...
class OtherPitcIndicadorMetadataAdapter(IndicatorMetadataPort):
    
    METADATA_ID = 'jHjC9XIJbhL'
    ...
    def find_indicator_metadata(self):
        ...
        for indicator_metadata in indicators_metadata:
            ...
            name = name.split('HTS_TST (N, TA, OtherPITC/Age/Sex/Result): HTS received results ')[1]
