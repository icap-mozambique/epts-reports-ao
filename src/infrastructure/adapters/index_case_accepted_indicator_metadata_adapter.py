...
class IndexCaseAcceptedIndicatorMetadataAdapter(IndicatorMetadataPort):
    
    METADATA_ID = 'HCzzXAWX6Qm'
    ...
    def find_indicator_metadata(self):
        ...
        for indicator_metadata in indicators_metadata:
            ...
            name = name.split('HTS_INDEX (N, TA, Index/Age/Sex/CasesAccepted): Number of index cases accepted ')[1]
