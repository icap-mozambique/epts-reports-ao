...
class PregnantIndicatorMetadataAdapter(IndicatorMetadataPort):

    METADATA_ID = 'URyL7Dv9F4U'
    ...
    def find_indicator_metadata(self):
        ...
        for indicator_metadata in indicators_metadata:
            ...
            name = name.split('HTS_TST (N, TA, PMTCT PostANC1 Pregnant-L&D/Age/Sex/Result): HTS received results ')[1]
