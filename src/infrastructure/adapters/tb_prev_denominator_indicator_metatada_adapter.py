...
class TbPrevDenominatorIndicatorMetadataAdapter(IndicatorMetadataPort):

    METADATA_ID = 'ZTIJhTJifYT'
    ...
    def find_indicator_metadata(self):
        ...
        for indicator_metadata in indicators_metadata:
            ...
            name = name.split('TB_PREV (D, TA, Age/Sex/NewExistingArt/HIVStatus): IPT ')[1]
