...
class PmtctHeiPosIndicatorsMetadataAdapter(IndicatorMetadataPort):
   METADATA_ID = 'yNfuoYteftA'
   ...
   def find_indicator_metadata(self):
        ...
        for indicator_metadata in indicators_metadata:
            ...
            name = name.split('PMTCT_HEI_POS_ART (N, TA, Age/HIVStatus/ARTStatus): Infant Testing ')[1]
