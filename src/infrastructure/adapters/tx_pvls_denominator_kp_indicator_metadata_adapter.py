...
class TxPvlsDenominatorKpIndicatorMetadataAdapter(IndicatorMetadataPort):
    
    METADATA_ID = 'IAFS0LzcpTX'
    ...
    def find_indicator_metadata(self):
       ...
       for indicator_metadata in indicators_metadata:
            ...
            name = name.split('TX_PVLS (D, TA, KeyPop/HIVStatus): Viral Load Documented ')[1]
