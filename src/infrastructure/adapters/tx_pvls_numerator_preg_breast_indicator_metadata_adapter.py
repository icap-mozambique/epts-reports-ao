...
class TxPvlsNumeratorPregBreastIndicatorMetadataAdapter(IndicatorMetadataPort):

    METADATA_ID = 'M4jFFs2xTAx'
    ...
    def find_indicator_metadata(self):
        ...
        for indicator_metadata in indicators_metadata:
            ...
            name = name.split('TX_PVLS (N, TA, Sex/PregnantOrBreastfeeding/HIVStatus): 12 Months Viral Load < 1000 ')[1]
